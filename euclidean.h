...
public:
    ...
    typedef std::array<std::array <long double, 2>, 2> matrix22;
    typedef std::array<std::array <long double, 3>, 3> matrix33;
    typedef std::array<std::array <long double, 4>, 4> matrix44;
    typedef std::array<long double, 2> cartesian2;
    typedef std::array<long double, 3> cartesian3;
    typedef std::array<long double, 4> cartesian4;
    ...
    cartesian3 add(cartesian3 vec1, cartesian3 vec2)
    {
        cartesian3 sum;
    ...
    double dot(cartesian3 vec1, cartesian3 vec2)
    {
        double dotScalar;
    ...
    matrix33 outerProduct(cartesian3 columnVector, cartesian3 rowVector)
    {
        matrix33 rProduct;
    ...
    cartesian3 rightCartesianCross(cartesian3 vec1, cartesian3 vec2)
    {
    ...
    cartesian3 normalize(cartesian3 givenVector)
    {
        double sumOfSquares;
